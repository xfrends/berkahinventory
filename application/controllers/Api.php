 ...
 *
 * | DESCRIPTION |
 *  If you want to create new Controller as API, 
 * you should extend that class with this class. Why? because this class
 * will take care of the Basic AUTH and automatically select the language
 * you choose (based on url target [see: routes.php]). So on other controller
 * you just need directly validate the http data and display all the label/message
 * with lang helper
 */
