...
function JSON_RESPONSE1($error_code, $message, $withDelimiter = false, $data = array(), $stop = true)
{
    $final_data = array();
    // Wrapping $data inside 'data';
    ...
    JSON_RESPONSE($error_code, $message, $withDelimiter, $final_data, $stop);
}
...
/**
 * Variable Checker if NOT_EMPTY
 * @param any $data Variable to be checked NOT_EMPTY
 *
 * @return boolean Return TRUE if $data is not empty and return FALSE if data is empty
 */
