<div class="row">
    <div class="col-md-6 col-sm-6 col-xs-12 form-search-panel">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo lang('Search') ?><small><?php echo lang('Master') ?> <?php echo lang('Chapter') ?></small></h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <form name="search" class="form-horizontal form-label-left">
                    <div class="form-group">
                        <label class="control-label col-sm-3 col-xs-12"><?php echo lang('Chapter') ?> <?php echo lang('Name') ?></label>
                        <div class="col-sm-6 col-xs-12">
                            <input type="text" class="form-control col-xs-12" name="chapter_name" id="search">
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <button type="button" class="btn btn-primary search-data"><i class="fas fa-search"></i> <?php echo lang('Search') ?></button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 form-action-panel">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo lang('Action') ?><small><?php echo lang('Master') ?> <?php echo lang('Chapter') ?></small></h2>
                <div class="clearfix"></div>
            </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 table-data-panel">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo lang('List') ?><small><?php echo lang('Master') ?> <?php echo lang('Chapter') ?></small></h2>
...
$(document).ready(function() {
    ...
    // Load Form Add
    let form_add = sendAjax('<?php echo base_url('chapter/create') ?>');
    ...
    $(".search-data").on('click', function() {
        let uri = '<?php echo base_url('chapter/index') ?>';
    ...
    // Trigger search button when enter
