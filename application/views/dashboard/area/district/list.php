<div class="row">
    <div class="col-md-6 col-sm-6 col-xs-12 form-search-panel">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo lang('Search') ?><small><?php echo lang('District') ?> <?php echo lang('Area') ?></small></h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <form name="search" class="form-horizontal form-label-left">
                    <div class="form-group">
                        <label class="control-label col-sm-3 col-xs-12"><?php echo lang('District') ?> <?php echo lang('Name') ?></label>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 form-action-panel">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo lang('Action') ?><small><?php echo lang('District') ?> <?php echo lang('Area') ?></small></h2>
                <div class="clearfix"></div>
            </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 table-data-panel">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo lang('List') ?><small><?php echo lang('District') ?> <?php echo lang('Area') ?></small></h2>
...
$(document).ready(function() {
    ...
    // Load Form Add
    let form_add = sendAjax('<?php echo base_url('area/create_district') ?>');
    ...
    $(".search-data").on('click', function() {
        let uri = '<?php echo base_url('area/read_district') ?>';
