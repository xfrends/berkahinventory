<form id="parsley-form" class="form-horizontal" novalidate name="form_add">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <label class="control-label"><?php echo lang('Regency') ?> <?php echo lang('ID') ?> <span class="required">*</span></label>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="dropdown">
           <?php echo form_dropdown('province_id', $province, null, 'class="form-control"'); ?>
        </div>
    </div>
...
<script>
    $("#parsley-form").parsley().on('field:validated',function(){}).on('form:submit', function(){
        var link = "<?php echo base_url('area/create_regency') ?>",
