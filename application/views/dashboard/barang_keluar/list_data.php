<table class="datatable table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $r->barang_masuk_created_at ?></td>
...
<script>
    ...
    $(".action_edit").on('click', function() {
        let target = '<?php echo base_url('barang/update_barang_keluar') ?>/' + $(this).val();
    ...
    $(".action_delete").on('click', function() {
        if(confirm('<?php echo lang('ConfirmActionDelete') ?>')) {
            let target = '<?php echo base_url('barang/delete_barang_keluar') ?>/' + $(this).val();
