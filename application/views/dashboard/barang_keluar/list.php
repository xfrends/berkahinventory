                ...
                <form name="search" class="form-horizontal form-label-left">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <input type="text" class="form-control col-xs-12" name="kode_barang" id="search">
                        </div>
                    </div>
                    <div class="clearfix"></div>
...
$(document).ready(function() {
    ...
    // Load Form Add
    let form_add = sendAjax('<?php echo base_url('barang/create_barang_keluar') ?>');
    ...
    $(".search-data").on('click', function() {
        let uri = '<?php echo base_url('barang/barang_keluar') ?>';
